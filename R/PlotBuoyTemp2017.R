...
LTERdf<-read.csv('Data/sensor_mendota_lake_watertemp_hi_res_Sep28_2017.csv', header=T, stringsAsFactors = F)
...
LTERmet<-read.csv('Data/sensor_mendota_lake_met_hourly_Sep28_2017.csv', header=T, stringsAsFactors = F)
