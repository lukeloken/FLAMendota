...
plot(surfaceallsites$co2, surfaceallsites$CO2guessDIC)
abline(0,1)
...
plot(surfaceallsites$sampledate, surfaceallsites$CO2guessDIC, xlab='', ylab='CO2 (uM)', ylim=range(c(surfaceallsites$CO2guessDIC, surfaceallsites$co2), na.rm=T), col='red', pch=16, type="p", xlim=range(surfaceallsites$sampledate))
points(surfaceallsites$sampledate, surfaceallsites$co2, col='black', pch=16, type="p")
